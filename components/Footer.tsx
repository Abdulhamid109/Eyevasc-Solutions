        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-4 mb-8'>
          ...
          <div>
            ...
            <div className='flex space-x-4'>
              ...
              {/* instagram link */}
              <a target='blank' href='https://www.instagram.com/eyevascsolution?igsh=MWliNmxkdXppNmlj' className='w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors'>
                <svg className='w-5 h-5' fill='currentColor' viewBox='0 0 24 24'>
