        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="procedure-details">
            <AccordionTrigger className="border p-4 rounded-lg hover:bg-blue-50">
              <h2 className="text-xl font-semibold">Gynecomastia Surgery Procedure Details</h2>
            </AccordionTrigger>
            <AccordionContent className="p-4 bg-blue-50 rounded-b-lg">
              <p className="mb-4">
                Gynecomastia treatment may involve one or a combination of the following surgical techniques, depending on the nature and severity of the condition.
              </p>

              <h3 className="text-lg font-semibold mb-2">Surgical Techniques</h3>

              <ul className="list-disc pl-6 space-y-3 mb-4">
                <li>
                  <strong>Liposuction:</strong> Removes excess fatty tissue through small, discreet incisions. Best suited for mild cases with minimal glandular tissue.
                </li>
                <li>
                  <strong>Excision Surgery:</strong> Removes dense glandular tissue and excess skin. In severe cases, repositioning of the nipple or areola may be required.
                </li>
                <li>
                  <strong>Combination Surgery:</strong> A combination of liposuction and excision for moderate to severe gynecomastia, offering optimal contouring results.
                </li>
              </ul>

              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Anesthesia:</strong> General anesthesia or local anesthesia with sedation
                </li>
                <li>
                  <strong>Duration:</strong> Approximately 1–3 hours, depending on complexity
                </li>
              </ul>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="recovery">
            <AccordionTrigger className="border p-4 rounded-lg hover:bg-blue-50">
              <h2 className="text-xl font-semibold">Recovery After Gynecomastia Surgery</h2>
            </AccordionTrigger>
            <AccordionContent className="p-4 bg-blue-50 rounded-b-lg">
              <ul className="list-disc pl-6 space-y-2">
                <li>Swelling, bruising, and mild discomfort are common initially</li>
                <li>A compression garment is worn for several weeks to support healing</li>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Final results become apparent within 3–6 months as swelling completely subsides</li>
              </ul>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="effectiveness">
            <AccordionTrigger className="border p-4 rounded-lg hover:bg-blue-50">
              <h2 className="text-xl font-semibold">Effectiveness of Gynecomastia Treatment</h2>
            </AccordionTrigger>
            <AccordionContent className="p-4 bg-blue-50 rounded-b-lg">
              <p className="mb-4">
                Gynecomastia surgery provides long-term and often permanent results when performed by experienced surgeons.
              </p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <AccordionItem value="eligibility">
            <AccordionTrigger className="border p-4 rounded-lg hover:bg-blue-50">
              <h2 className="text-xl font-semibold">Eligibility for Gynecomastia Surgery</h2>
            </AccordionTrigger>
            <AccordionContent className="p-4 bg-blue-50 rounded-b-lg">
              <ul className="list-disc pl-6 space-y-2">
          ...
          <AccordionItem value="benefits">
            <AccordionTrigger className="border p-4 rounded-lg hover:bg-blue-50">
              <h2 className="text-xl font-semibold">Benefits of Gynecomastia Treatment</h2>
            </AccordionTrigger>
            <AccordionContent className="p-4 bg-blue-50 rounded-b-lg">
              <ul className="list-disc pl-6 space-y-2">
          ...
          <AccordionItem value="risks">
            <AccordionTrigger className="border p-4 rounded-lg hover:bg-blue-50">
              <h2 className="text-xl font-semibold">Risks and Side Effects of Gynecomastia Surgery</h2>
            </AccordionTrigger>
            <AccordionContent className="p-4 bg-blue-50 rounded-b-lg">
              <p className="mb-4">
                Gynecomastia treatment is generally safe, though temporary side effects may occur.
              </p>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <p className="mt-4">
                Following post-operative care instructions and attending regular follow-up visits help minimize risks and ensure optimal results.
              </p>
            </AccordionContent>
          </AccordionItem>
        </Accordion>
