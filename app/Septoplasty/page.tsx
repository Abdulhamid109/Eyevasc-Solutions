      ...
      <section className="max-w-5xl mx-auto">
        <header className="mb-10">
          ...
          <p className="text-base leading-relaxed text-gray-600">
            Septoplasty is a surgical procedure performed to correct a deviated
            nasal septum, the wall of cartilage and bone that separates the two
            nostrils. When the septum is misaligned, it can cause breathing
            difficulties, chronic nasal blockage, recurrent sinus infections,
        ...
        <section className="mb-10">
          <p className="text-base leading-relaxed text-gray-700">
            At Eyevasc Solutions, septoplasty is performed using advanced ENT
            surgical techniques to restore proper nasal airflow and improve
        ...
        <section className="mb-12">
          ...
          <p className="text-base leading-relaxed mb-4">
            Our experienced ENT surgeons ensure a safe and precise septoplasty
            procedure tailored to the patient’s condition.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>Duration: Typically 30–90 minutes, depending on the severity of deviation</li>
            <li>
              Anesthesia: Performed under general anesthesia or local anesthesia
              with sedation
            </li>
          ...
          <p className="text-base leading-relaxed mt-4">
            Septoplasty is usually completed as a day-care surgery, allowing
        ...
        <section className="mb-12">
          ...
          <p className="text-base leading-relaxed mb-4">
            Recovery after septoplasty is gradual and generally well tolerated
        ...
        <section className="mb-12">
          ...
          <p className="text-base leading-relaxed mb-4">
            Septoplasty is highly effective for correcting nasal obstruction
        ...
        <section className="mb-12">
          ...
          <p className="text-base leading-relaxed mt-4">
            A detailed ENT evaluation at Eyevasc Solutions ensures accurate
            diagnosis and suitability for surgery.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">Benefits of Septoplasty</h2>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
        ...
        <section>
          ...
          <p className="text-base leading-relaxed mb-4">
            Septoplasty is generally safe, but some temporary effects may occur
          ...
          <p className="text-base leading-relaxed mt-4">
            Following post-operative care instructions and choosing an
            experienced ENT surgeon significantly reduces these risks.
          </p>
        </section>
      </section>
    </main>
