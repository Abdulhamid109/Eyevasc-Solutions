      ...
      <section className="max-w-5xl mx-auto">
        <header className="mb-10">
          ...
          <p className="text-base leading-relaxed text-gray-600">
            ...
            tonsils—two oval-shaped lymph tissues located at the back of the
            throat that help protect the body from infections. When tonsils
            become frequently infected, enlarged, or cause breathing and
            swallowing difficulties, surgical removal becomes the most
            effective treatment.
          </p>
        </header>
        ...
        <section className="mb-10">
          <p className="text-base leading-relaxed text-gray-700">
            At Eyevasc Solutions, tonsillectomy is performed using safe and
            advanced ENT surgical techniques to ensure minimal discomfort,
            faster recovery, and long-term relief from recurring tonsil
            problems.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-base leading-relaxed mb-4">
            Our ENT specialists perform tonsillectomy with precision and care
            to deliver optimal clinical outcomes.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>Duration: Approximately 30–60 minutes</li>
            <li>
              Anesthesia: Performed under general anesthesia, ensuring the
              patient is fully asleep and pain-free
            </li>
            <li>Tonsils are removed through the mouth</li>
            <li>No external cuts or visible scars</li>
            <li>
              Advanced techniques such as cautery or laser may be used to
              reduce bleeding
            </li>
            <li>
              Minimally invasive approach with no external incisions for
              quicker healing
            </li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-base leading-relaxed mb-4">
            Recovery after tonsillectomy is gradual and generally smooth when
        ...
        <section className="mb-12">
          ...
          <p className="text-base leading-relaxed mb-4">
            Tonsillectomy is highly effective in managing chronic or recurrent
            tonsillitis and related complications.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">Benefits of Tonsillectomy</h2>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
            <li>Reduced frequency of tonsil infections</li>
            <li>Improved breathing by removing airway obstruction</li>
            <li>
              Better sleep quality, especially for patients with snoring or
              sleep apnea
            </li>
        ...
        <section className="mb-12">
          ...
          <p className="text-base leading-relaxed mb-4">
            Tonsillectomy is generally safe, but some side effects may occur
